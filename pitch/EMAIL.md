# Reply drafts — Adda Philadelphia concept

Links to use (after GitHub Pages is on for the `main` branch):
- Pitch page (film + PDF + live site): https://hvndal.github.io/unapologeticfoods/pitch/
- Live concept: https://hvndal.github.io/unapologeticfoods/
- Attach: `pitch/Adda-Philadelphia-Proposal-Mander-Studio.pdf` (6 MB)
...
**Watch the film and open the live concept here:**
https://hvndal.github.io/unapologeticfoods/pitch/

It's a working concept for Adda Philadelphia: a fire-lit hero, the Butter Chicken Experience sold as the ritual it is, a menu of places, and booking in three taps. It's built for phones first, since that's where most guests will meet you.
